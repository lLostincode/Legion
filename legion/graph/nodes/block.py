from typing import Any, Dict, Optional, Type, Union, get_type_hints, TypeVar, get_args, get_origin, List
from pydantic import BaseModel, ValidationError as PydanticValidationError
from datetime import datetime

from ..state import GraphState
from .base import NodeBase
from ...blocks.base import FunctionalBlock, ValidationError as BlockValidationError
from ..channels import LastValue, Channel
