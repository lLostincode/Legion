from typing import Optional, Type, Dict, Any, get_type_hints, List, Union, Annotated, get_args, get_origin
...
class FunctionTool(BaseTool):
    ...
    def run(self, **kwargs):
        ...
        if self.instance is not None and self.is_instance_method:
            ...
            logger.debug(f"[TOOL RUN] Calling as standalone function")
